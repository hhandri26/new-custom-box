...
Route::get('/gallery_custombox','FrontController@gallery')->name('gallery_custombox');
...
Route::get('/models','FrontController@models')->name('models');
Route::get('/models_detail','FrontController@models_detail')->name('models_detail');
