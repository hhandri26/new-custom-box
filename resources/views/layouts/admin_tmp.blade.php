            ...
            <div class="navbar nav_title" style="border: 0;">
              <div class="width-logo" style="background-color:#fff ;text-align: center">
                        <a href="{{url('home')}}" class="logo">
                            <img src="{{asset('public/img/logo-pt.png')}}" alt="logo" class="logo-lg" style="height: 70px" />
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                 @foreach(App\Models\MenuModels::select('a.role_id','a.menu_id','b.menu_name as menu','b.icon as icon','b.id as id_menu')->leftjoin('t_menu as b','a.menu_id','=','b.id')->whereRaw($sql2)->orderby('b.sort','ASC')->get() as $row)
                    <li><a><i class="{{$row->icon}}"></i>{{$row->menu}} <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                         @foreach(App\Models\OnlySubMenuModels::select('a.menu_id','b.sub_menu_name','b.url')->leftjoin('t_sub_menu as b','a.sub_menu_id','=','b.id')->where('a.menu_id',$row->menu_id)->where('a.role_id',$row->role_id)->get() as $row2)
