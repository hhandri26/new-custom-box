...
<div class="row">
    <div class="pull-right">
        <a href="{{ route('admin_category_article_form')}}" class="btn btn-sm btn-success">
            <span class="fa fa-plus"></span> Add
        </a>
        <input type="hidden" id="delete" value="{{route('delete') }}?id=">
        <input type="hidden" id="edit" value="{{route('admin_category_article_edit')}}?id=">
    </div>
...
function edit(sid){
  ...
  function deleted(sid){    
    ...
    var url   = url_delete+sid+"&table=t_article_category&refresh=admin_category_article";
